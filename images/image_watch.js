  ...
  static loadSubCommentImage=async(listsubcomment,idcomment,iduser,userrname)=>
  {
    let html_subcomments="";
      ...
      for (let i = 0; i < listsubcomment.length; i++) {
        ...
        const svgfill_existlikesubcomment = this.svgfill_existlikesubcomment(subcomment.existlikeloginuser);
        let show_edit_delete_subcomment = this.show_edit_delete_subcomment(subcomment.existsubcommentloginuser);
        html_subcomments+=`
