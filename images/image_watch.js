...
//******************************************************** */
 ...
 //LOAD COMMENT IMAGE
  static loadCommentImage=async(listcommentpost,idpost,iduser,userrname)=>
  {
    let html_comments_posts="";
      ...
      const loadSubCommentPostPromise = this.loadSubCommentPost(listsubcommentpost,idcomment, iduser,userrname);
